...
export const metadata = {
  ...
  description:
    'Explora todos los destinos gastronómicos disponibles: Venezuela, Rumanía, Malí y más. Cada país con sus platos típicos, ingredientes y cultura culinaria.',
  alternates: {
    canonical: '/paises',
    languages: {
      es: '/paises',
  ...
  openGraph: {
    ...
    description: 'Todos los países disponibles: Venezuela, Rumanía, Malí y más destinos culinarios.',
    url: '/paises',
    images: ['/og/home.png'],
  },
  twitter: {
    ...
    title: 'Destinos Gastronómicos | Comidas del Mundo',
    description: 'Explora la gastronomía de Venezuela, Rumanía, Malí y más.',
    images: ['/og/home.png'],
  },
};
...
const paisesHtml = `
  ...
  <main class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 relative z-10 flex flex-col items-center">
    ...
    <section class="w-full max-w-4xl grid md:grid-cols-3 gap-6 mb-20" aria-label="Lista de países">
